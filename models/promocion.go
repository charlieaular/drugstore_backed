...
type Promocion struct {
	...
	FechaInicio utils.CustomDate `gorm:"column:fecha_inicio;type:DATE;unique" json:"fecha_inicio" binding:"required"`
	FechaFin    utils.CustomDate `gorm:"column:fecha_fin;type:DATE;" json:"fecha_fin" binding:"required"`
}
